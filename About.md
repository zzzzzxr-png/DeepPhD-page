...
<!-- SOURCE: manuscript Introduction. About is not Methods; MPGN/FPN/RN are shown in the figure. -->
...
<!-- SOURCE: manuscript Introduction. Contributions = physical dissection / flow modeling / flow + denoising; joint optimization is the training scheme after the figure. -->
